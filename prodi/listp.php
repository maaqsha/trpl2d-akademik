    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="table-secondary"><a href="index.php?id=<?= $data['id'] ?>&page=prodi-edit" class="btn btn-warning btn-sm">EDIT</a>
...
<a href='index.php?page=prodi-create' class="btn btn-primary">Tambah Data</a>